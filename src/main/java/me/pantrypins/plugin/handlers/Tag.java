package me.pantrypins.plugin.handlers;
...
public class Tag {
    ...
    public String getCustomPlaceholder(String identifier, String placeholder) {
        if (!PantryPins.getInstance().getTagManager().getTagConfig().isSet("tags." + identifier + ".custom-placeholders." + placeholder)) {
            return PantryPins.getInstance().getTagManager().getMessages().getString("invalid-custom-placeholder", "&cUnknown Placeholder");
        }

        return PantryPins.getInstance().getTagManager().getTagConfig().getString("tags." + identifier + ".custom-placeholders." + placeholder);
    }
