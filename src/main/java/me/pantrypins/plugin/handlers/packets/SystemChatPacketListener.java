package me.pantrypins.plugin.handlers.packets;
...
public class SystemChatPacketListener extends PacketAdapter {
    ...
    public void onPacketSending(PacketEvent event) {
        ...
        if (chatComponent != null) {
            ...
            try {
                ...
                // Bukkit.getLogger().warning("[PantryPins] Failed to parse chat JSON: " + e.getMessage());
            }
        }
    }
    ...
    private String replaceTagPlaceholders(String text, UUID uuid, Player viewer) {
        ...
        String displayTag = PantryPins.getInstance().getConfig().getString("placeholders.chat.none-output");
