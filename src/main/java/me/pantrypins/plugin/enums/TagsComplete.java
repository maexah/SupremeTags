package me.pantrypins.plugin.enums;

import me.pantrypins.plugin.PantryPins;
import me.pantrypins.plugin.utils.commands.BukkitCompleter;
                ...
                if (sender.hasPermission("supremetags.admin")) {
                    if (args[0].equalsIgnoreCase("create") || args[0].equalsIgnoreCase("settag") || args[0].equalsIgnoreCase("delete") || args[0].equalsIgnoreCase("reset")) {
                        ...
                        if (args.length == 0) {
                            ...
                            completions.addAll(PantryPins.getInstance().getCategoryManager().getCatorgies());
                        }
                    }
                }
