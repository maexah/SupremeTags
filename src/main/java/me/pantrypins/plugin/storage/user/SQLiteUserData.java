...
public class SQLiteUserData {
    ...
    public boolean exists(Player player) {
        try (Connection connection = PantryPins.getSQLite().getConnection();
    ...
    public void createPlayer(Player player) {
        ...
        try (PreparedStatement statement = PantryPins.getSQLite().getConnection().prepareStatement(
    ...
    public static void setActive(OfflinePlayer player, String identifier) {
        ...
        try (PreparedStatement statement = PantryPins.getSQLite().getConnection().prepareStatement(sql)) {
