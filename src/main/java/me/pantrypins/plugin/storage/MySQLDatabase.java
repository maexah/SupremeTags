...
public class MySQLDatabase {
    ...
    public MySQLDatabase(String host, int port, String database, String username, String password, boolean useSSL) {
        config.setIdleTimeout(PantryPins.getInstance().getConfigManager().getConfig("data.yml").get().getInt("data.mysql-pool-settings.timeouts.idle"));
        config.setMaxLifetime(PantryPins.getInstance().getConfigManager().getConfig("data.yml").get().getInt("data.mysql-pool-settings.timeouts.max-lifetime"));
        config.setConnectionTimeout(PantryPins.getInstance().getConfigManager().getConfig("data.yml").get().getInt("data.mysql-pool-settings.timeouts.connection"));
        config.setMinimumIdle(PantryPins.getInstance().getConfigManager().getConfig("data.yml").get().getInt("data.mysql-pool-settings.minimum-idle"));
        config.setRegisterMbeans(true);
        config.setMaximumPoolSize(PantryPins.getInstance().getConfigManager().getConfig("data.yml").get().getInt("data.mysql-pool-settings.maximum-pool-size"));
    ...
    public void openConnection() {
        try {
            ...
            PantryPins.getInstance().getLogger().warning("MYSQL: Something went wrong with connecting to the MySQL database.\n" + e);
        }
    }
