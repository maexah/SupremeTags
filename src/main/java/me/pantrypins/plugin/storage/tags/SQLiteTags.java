package me.pantrypins.plugin.storage.tags;
...
import me.pantrypins.plugin.storage.SQLiteDatabase;
...
public class SQLiteTags {
    ...
    private void createTables() {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "SQLiteTags: Failed to create tables", e);
        }
    }
    ...
    public void saveTag(Tag tag) {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "SQLiteTags: Failed to save tag " + tag.getIdentifier(), e);
        }
    }
    ...
    public void deleteTag(String identifier) {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "SQLiteTags: Failed to delete tag " + identifier, e);
        }
    }
    ...
    public Map<String, Tag> loadTags() {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "SQLiteTags: Failed to load tags", e);
        }
    ...
    private Map<PotionEffectType, Integer> deserializeEffects(String json) {
        ...
        try {
            ...
            PantryPins.getInstance().getLogger().warning("SQLiteTags: Could not deserialize effects json: " + e.getMessage());
        }
        return result;
    }
}
