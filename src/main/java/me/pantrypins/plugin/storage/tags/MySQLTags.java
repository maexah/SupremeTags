...
import me.pantrypins.plugin.storage.MySQLDatabase;
...
public class MySQLTags {
    ...
    private void createTables() {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "MySQLTags: Failed to create tables", e);
        }
    }
    ...
    public void saveTag(Tag tag) {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "MySQLTags: Failed to save tag " + tag.getIdentifier(), e);
        }
    }
    ...
    public void deleteTag(String identifier) {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "MySQLTags: Failed to delete tag " + identifier, e);
        }
    }
    ...
    public Map<String, Tag> loadTags() {
        ...
        try (Connection conn = db.getConnection();
            ...
            PantryPins.getInstance().getLogger().log(Level.SEVERE, "MySQLTags: Failed to load tags", e);
        }
    ...
    private Map<PotionEffectType, Integer> deserializeEffects(String json) {
        ...
        try {
            ...
            PantryPins.getInstance().getLogger().warning("MySQLTags: Could not deserialize effects json: " + e.getMessage());
        }
        return result;
    }
}
