package me.pantrypins.plugin.guis.configeditor;
...
import me.pantrypins.plugin.utils.XMaterialUtil;
...
public class ConfigTwoMenu extends Menu {
    ...
    private final FileConfiguration guis = PantryPins.getInstance()
    ...
    public String getMenuName() {
        return format("&8PantryPins Configuration");
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (slot) {
            ...
            case 0 -> new ConfigOneMenu(PantryPins.getMenuUtil(player)).open();
    ...
    private void toggleConfig(PantryPins plugin, String path, ItemStack clickedItem) {
    ...
    private void toggleConfigFile(String file, String path, ItemStack clickedItem) {
        boolean enable = clickedItem.getType().equals(GRAY_DYE);
        var manager = PantryPins.getInstance().getConfigManager();
    ...
    public void setMenuItems() {
        ...
        List<String> updateCheck = List.of(
                ...
                "&7version of PantryPins is available."
        );
