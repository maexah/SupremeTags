package me.pantrypins.plugin.guis.confirm;
...
public class ConfirmationMenu extends Menu {
    ...
    private final FileConfiguration config =
            PantryPins.getInstance().getConfigManager().getConfig("guis.yml").get();
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (slot == acceptSlot) {
            if (action.startsWith("delete-tag:")) {
                ...
                PantryPins.getInstance().getTagManager().deleteTag(player, identifier);
            }
        }
