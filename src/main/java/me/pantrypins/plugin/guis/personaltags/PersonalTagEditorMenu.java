...
public class PersonalTagEditorMenu extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getSlot() == 11) {
            ...
            PantryPins.getInstance().getPlayerManager().delete(player, menuUtil.getIdentifier());
            player.closeInventory();
    ...
    public void setMenuItems() {
        if (menuUtil.getIdentifier() != null) {
            Tag t = PantryPins.getInstance().getPlayerManager().getTag(menuUtil.getOwner().getUniqueId(), menuUtil.getIdentifier());
