package me.pantrypins.plugin.guis.tagactions;
...
public class TagActionsMenu extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (nbt.hasTag("name")) {
            ...
            if (name.equalsIgnoreCase("variants")) {
                ...
                new TagVariantsMenu(PantryPins.getMenuUtil(player), PantryPins.getInstance().getTagManager().getTag(id)).open();
            }

            if (name.equalsIgnoreCase("editor-tag")) {
                String id = menuUtil.getIdentifier();
                player.closeInventory();
                new SpecificTagMenu(PantryPins.getMenuUtilIdentifier(player, id)).open();
            }
            ...
            if (name.equalsIgnoreCase("withdraw-tag")) {
                PantryPins.getInstance().getVoucherManager().withdrawTag(player, menuUtil.getIdentifier());
                player.closeInventory();
            }
            ...
            if (name.equalsIgnoreCase("assign-tag")) {
                ...
                if (!UserData.getActive(player.getUniqueId()).equalsIgnoreCase("none")) {
                    Tag t1 = PantryPins.getInstance().getTagManager().getTag(UserData.getActive(player.getUniqueId()));
                ...
                PantryPins.getInstance().getTagManager().getTag(id).applyEffects(menuUtil.getOwner());
                ...
                if (PantryPins.getInstance().getConfig().getBoolean("settings.gui-messages")) {
                    ...
                    msgPlayer(player, select.replace("%identifier%", id).replaceAll("%tag%", PantryPins.getInstance().getTagManager().getTag(menuUtil.getIdentifier()).getTag().get(0)));
                }
            }
    ...
    public void setMenuItems() {
        ...
        for (String name : guis.getConfigurationSection("gui.tag-actions-menu.functions").getKeys(false)) {
            ...
            Tag tag = PantryPins.getInstance().getTagManager().getTag(menuUtil.getIdentifier());
