...
public class SkullUtil {
     ...
     */
    @NotNull
    public static ItemStack getSkullByBase64EncodedTextureUrl(@NotNull final PantryPins plugin, @NotNull final String base64Url) {
    ...
    public static String getTextureFromSkull(final PantryPins plugin, ItemStack item) {
     ...
     */
    @NotNull
    public static ItemStack getSkullByName(@NotNull final PantryPins plugin, @NotNull final String playerName) {
        final ItemStack head = plugin.getHead().clone();
     ...
     */
    @NotNull
    private static PlayerProfile getPlayerProfile(@NotNull final PantryPins plugin, @NotNull final String base64Url) {
